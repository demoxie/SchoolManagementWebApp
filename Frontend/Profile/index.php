    ...
    <div class="information">
        <div class="row col-11">
            ...
            <div class="data col-sm-12 col-md-8 col-lg-8">
                <h5 class="data-details">James Wakirwa</h5>
            </div>
        </div>
        <div class="row col-11">
            <div class="block col-sm-12 col-md-4 col-lg-4">
        ...
        <div class="row col-11">
            ...
            <div class="data col-sm-12 col-md-8 col-lg-8">
                <h5 class="data-details">15th April, 2000</h5>
            </div>
        </div>
        <div class="row col-11">
            <div class="block col-sm-12 col-md-4 col-lg-4">
            ...
            <div class="data col-sm-12 col-md-8 col-lg-8">
                <h5 class="data-details">Ungwan Alheri AshakaCem, Funakaye LGA, Gombe State</h5>
            </div>
        </div>
        <div class="row col-11">
            <div class="block col-sm-12 col-md-4 col-lg-4">
                <h5 class="block-content">Year Employed</h5>
            </div>
            <div class="data col-sm-12 col-md-8 col-lg-8">
                <h5 class="data-details">15th April, 2000</h5>
            </div>
        ...
        <div class="row col-11">
            <div class="block col-sm-12 col-md-4 col-lg-4">
                <h5 class="block-content">Staff ID</h5>
            </div>
            <div class="data col-sm-12 col-md-8 col-lg-8">
                <h5 class="data-details">AG-STA-3849583</h5>
            </div>
        </div>
        <div class="row col-11">
            <div class="block col-sm-12 col-md-4 col-lg-4">
                <h5 class="block-content">Role</h5>
            </div>
            <div class="data col-sm-12 col-md-8 col-lg-8">
                <h5 class="data-details">Mathematics Teacher</h5>
            </div>
        </div>
