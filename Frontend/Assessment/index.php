...
<body>
    ...
    <div class="container col-10">
        ...
        <h6 class=" promte col">Add</h6>
            <h6 class="demote col">Edit</h6>
            <h6 class="expel col">Delete Assessment</h6>
        </div>
        <hr>
        <div class="row col-12">
            <a href="#" class="btn btn-primary btn-lg col">Grade Scale<br><i class="fas fa-balance-scale"></i></a>
            <a href="#" class="btn btn-primary btn-lg col"><i></i>Evaluation<br><i class="fas fa-microscope"></i></a>
            <a href="#" class="btn btn-primary btn-lg col"><i></i>Psychomotor<br><i class="fas fa-brain"></i></a>
            <a href="#" class="btn btn-primary btn-lg col"><i></i>Skills<br><i class="fas fa-running"></i></a>
            <a href="#" class="btn btn-primary btn-lg col"><i></i>Remarks<br><i class="fas fa-thumbs-up"></i></a>
        </div>
        <hr>
        <div class="container fluid tag col-6">
        ...
        <hr>
         <div class="row col-12">
            <a href="../Assessment/ca_entry_sheet.php" class="btn btn-primary btn-lg col">CREATE CA TEST<br><i class="fas fa-edit"></i></a>
            <a href="#" class="btn btn-primary btn-lg col">CHECK CA TEST RESULTS<br><i class="fas fa-search"></i></a>
            <a href="#" class="btn btn-primary btn-lg col">CREATE EXAMS<br><i class="fas fa-chalkboard-teacher"></i></a>
        ...
        <h6 class=" promte col">Promote</h6>
            ...
            <h6 class="withdraw col">Withdraw</h6>
            <h6 class="expel col">Expel</h6>
        </div>
        <hr>
        <div class="row col-12">
                        <a href="#" class="btn btn-primary btn-lg col">CARRY OUT OPERATION INDIVIDUALLY<br><i class="fas fa-certificate"></i> <i class="fas fa-user"></i></a>
            <a href="#" class="btn btn-primary btn-lg col">CARRY OUT OPERATION BY CLASS<br><i class="fas fa-certificate"></i> <i class="fas fa-user-friends"></i></a>
