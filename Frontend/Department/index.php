...
<div id="top-nav-bar">
    <div id="nav-item-container">
        <a class="nav-btn"><i class="fas fa-home"></i>&nbsp;&nbsp;&nbsp;&nbsp;Home</a>
        <a class="nav-btn"><i class="fas fa-tachometer-alt"></i>&nbsp;&nbsp;&nbsp;&nbsp;Dashboard</a>
    </div>
    <div id="user">
        <a class="nav-btn"><i class="fas fa-user-circle"></i>&nbsp;&nbsp;&nbsp;logout</a>
    </div>
        ...
        <table class="table table-hover table-bordered">
            ...
            <tr>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <input type="text" class="form-control" id="hod" placeholder="HOD's name" name="department_hod"
                               required>
                    </div>
                    <div class="col">
                        <button type="button" class="btn " id="add_department" name="add_department col">Add
                            Department
                        </button>
                    </div>
                </div>
