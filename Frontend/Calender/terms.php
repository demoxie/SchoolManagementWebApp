...
<body>
<form class="form-inline col-10" method="post" role="form" enctype="multipart/form-data" id="term_form">
    <div class="row" style="margin-bottom: 30px">
        ...
        <div class="col">
            <label for="endingdate" class="mr-sm-1">Commencement Date</label>
            <input type="date" id="endingdate" class="form-control" name="commencementdate">
        </div>
        <div class="col">
            <label for="currentyear" class="mr-sm-1">Ending Date</label>
            <input type="date" id="currentyear" class="form-control" name="endingdate">
        </div>
        <div class="col"><br>
            <button type="submit" class="btn btn-primary col-12" name="addSession">Add Term</button>
        </div>
    </div>
    <div class="row">
        <div class="col-3">
    ...
    <table class="table table-hover table-bordered">
        ...
        <tr>
            ...
            <td>2020</td>
            <td>
                <button type="button" class="btn btn-primary col-12" name="addSession">Edit</button>
            </td>
            <td>
                <button type=button" class="btn btn-primary col-12" name="addSession">Delete</button>
            </td>
        </tr>
        <tr>
            <td>2</td>
